...
import { StyleSheet, Image, View, Button, Text, Pressable } from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.info}>
        ...
        <View style={[styles.box, { flex: 2, backgroundColor: "black" }]}>
...
const styles = StyleSheet.create({
  ...
  location: { color: "#9E9CB6", textAlign: "center", fontSize: 16 },
});
